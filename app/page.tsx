        ...
        <section id="pricing" className="py-32 px-6">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-400 max-w-2xl mx-auto font-medium">Sana uygun ödeme yöntemini seç ve hemen sisteme dahil ol. <span className="text-gray-300">Kısa bir süreliğine</span> tek seferlik ödeme ile ömür boyu sınırsız erişim.</p>
            </div>
              ...
              >
                ...
                <div className="mb-8">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="text-[10px] uppercase tracking-widest text-purple-400/80 font-bold">Erken Erişim Fırsatı</span>
                  </div>
                  <div className="flex items-baseline gap-2">
                    <span className="text-5xl font-black font-display">790</span>
              ...
              >
                ...
                <div className="mb-8">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="text-[10px] uppercase tracking-widest text-blue-400/80 font-bold">Erken Erişim Fırsatı</span>
                  </div>
                  <div className="flex items-baseline gap-2">
                    <span className="text-5xl font-black font-display">990</span>
                    <span className="text-xl text-gray-400 font-bold">TL</span>
                    <span className="text-xs text-gray-500 ml-1 font-medium tracking-wide">/ tek seferlik</span>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                <div>
                  ...
                  <p className="text-2xl font-black italic flex items-center gap-2 tracking-tighter">
                    <Wallet className="w-5 h-5 text-gray-400"/> 790 TL
                  </p>
                </div>
                <div>
